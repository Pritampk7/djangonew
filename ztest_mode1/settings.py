"""
Django settings for ztest_mode1 project.
...
SECRET_KEY = 'django-insecure-kq_hzs^ed-x@l1crxx9r)ta3)hzcqn!tn_&g_meb@mc^oxrt#d'
...
ALLOWED_HOSTS = [
    ...
    'http://c6fd-103-152-180-132.ngrok.io'
    ]
...
WSGI_APPLICATION = 'ztest_mode1.wsgi.application'
